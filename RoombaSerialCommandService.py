...
import socket, serial, sys, signal
...
service_zc_info = ServiceInfo('_roomba._tcp.local.',
                   service_host + ':' + str(service_port) + '._roomba._tcp.local.',
                   service_host, service_port, 0, 0, service_zc_desc)
zeroconf = Zeroconf()
